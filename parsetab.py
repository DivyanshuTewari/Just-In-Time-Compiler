...
_lr_productions = [
  ...
  ('program -> statement','program',1,'p_program','gui.py',107),
  ('program -> statement program','program',2,'p_program','gui.py',108),
  ('statement -> assignment','statement',1,'p_statement','gui.py',113),
  ('statement -> expression SEMICOLON','statement',2,'p_statement','gui.py',114),
  ('statement -> expression','statement',1,'p_statement','gui.py',115),
  ('assignment -> IDENTIFIER EQUALS expression SEMICOLON','assignment',4,'p_assignment','gui.py',119),
  ('expression -> IF LPAREN expression RPAREN expression ELSE expression','expression',7,'p_expression_ifelse','gui.py',123),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','gui.py',127),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','gui.py',128),
  ('expression -> expression MUL expression','expression',3,'p_expression_binop','gui.py',129),
  ('expression -> expression DIV expression','expression',3,'p_expression_binop','gui.py',130),
  ('expression -> expression AND expression','expression',3,'p_expression_binop','gui.py',131),
  ('expression -> expression OR expression','expression',3,'p_expression_binop','gui.py',132),
  ('expression -> expression EQ expression','expression',3,'p_expression_binop','gui.py',133),
  ('expression -> expression NE expression','expression',3,'p_expression_binop','gui.py',134),
  ('expression -> expression LT expression','expression',3,'p_expression_binop','gui.py',135),
  ('expression -> expression GT expression','expression',3,'p_expression_binop','gui.py',136),
  ('expression -> expression LE expression','expression',3,'p_expression_binop','gui.py',137),
  ('expression -> expression GE expression','expression',3,'p_expression_binop','gui.py',138),
  ('expression -> NOT expression','expression',2,'p_expression_unop','gui.py',142),
  ('expression -> factor','expression',1,'p_expression_factor','gui.py',146),
  ('factor -> BOOL','factor',1,'p_factor_bool','gui.py',150),
  ('factor -> NUMBER','factor',1,'p_factor_number','gui.py',154),
  ('factor -> IDENTIFIER','factor',1,'p_factor_identifier','gui.py',158),
  ('factor -> STRING','factor',1,'p_factor_string','gui.py',162),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','gui.py',166),
]
